...
// so that the device (GPU) can see this variable
__device__ const float RADIUS = 5.f;
...
#else
    fprintf(stdout, "Number of Trials = %10d, Blocksize = %8d, MegaTrials/Second = %10.4lf, Probability = %6.2f%%\n",
